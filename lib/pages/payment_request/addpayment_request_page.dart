...
class _AddAdvancePaymentRequestPageState
            ...
            _details
                .map(
                  (e) => {
                    "id": 0,
                    "description":
                        e.description ?? "", // thêm description nếu có
                    "hblNo": e.hblNo,
  ...
  Widget build(BuildContext context) {
    ...
    String _convertNumberToWords(double number) {
      ...
      const numberToWords = {
      0: 'Không',1: 'Một',2: 'Hai',3: 'Ba',4: 'Bốn',5: 'Năm',6: 'Sáu',7: 'Bảy',8: 'Tám',9: 'Chín',10: 'Mười',100: 'Trăm',1000: 'Nghìn',1000000: 'Triệu',1000000000: 'Tỷ',
      };
                              ...
                              onChanged:
                                  (val) => setState(() {
                                    ...
                                    _amountController.text =
                                        _getTotalAmount().toString();
                                    _amountInWordsController
                                        .text = _convertNumberToWords(
                                      _getTotalAmount(),
                                    );
                                  }),
                              decoration: const InputDecoration(
                            ...
                            TextFormField(
                              ...
                              onChanged: (val) {
                                setState(() {
                                  ...
                                  detail.intoMoney =
                                      detail.amountNumber * detail.exchangeRate;
                                  _amountController.text =
                                      _getTotalAmount().toString();
                                  _amountInWordsController.text =
                                      _convertNumberToWords(_getTotalAmount());
                                });
                              },
                              decoration: const InputDecoration(
                                border: OutlineInputBorder(),
